...
int user_get_time( USER_TIME_S *current_time )
{
    ...
    //week
    if (RT_NULL != rt_strstr(week, "Mon"))
    {
        current_time->weekday = 1;
    }else if (RT_NULL != rt_strstr(week, "Tue"))
    {
        current_time->weekday = 2;
    }else if (RT_NULL != rt_strstr(week, "Wed"))
    {
        current_time->weekday = 3;
    }else if (RT_NULL != rt_strstr(week, "Thu"))
    {
        current_time->weekday = 4;
    }else if (RT_NULL != rt_strstr(week, "Fri"))
    {
        current_time->weekday = 5; 
    }else if (RT_NULL != rt_strstr(week, "Sat"))
    {
        current_time->weekday = 6;  
    }else if (RT_NULL != rt_strstr(week, "Sun"))
    {
        current_time->weekday = 7; 
    }
    // month
    if (RT_NULL != rt_strstr(month, "Jan"))
    {
        current_time->month = 1;
    }else if (RT_NULL != rt_strstr(month, "Feb"))
    {
        current_time->month = 2;
    }else if (RT_NULL != rt_strstr(month, "Mar"))
    {
        current_time->month = 3;
    }else if (RT_NULL != rt_strstr(month, "Apr"))
    {
        current_time->month = 4;
    }else if (RT_NULL != rt_strstr(month, "May"))
    {
        current_time->month = 5; 
    }else if (RT_NULL != rt_strstr(month, "Jun"))
    {
        current_time->month = 6;  
    }else if (RT_NULL != rt_strstr(month, "Jul"))
    {
        current_time->month = 7; 
    }else if (RT_NULL != rt_strstr(month, "Aug"))
    {
        current_time->month = 8; 
    }else if (RT_NULL != rt_strstr(month, "Sep"))
    {
        current_time->month = 9; 
    }else if (RT_NULL != rt_strstr(month, "Oct"))
    {
        current_time->month = 10; 
    }else if (RT_NULL != rt_strstr(month, "Nov"))
    {
        current_time->month = 11; 
    }else if (RT_NULL != rt_strstr(month, "Dec"))
    {
