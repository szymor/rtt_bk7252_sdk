...
#define DATA_TEMPLATE_LIGHT_THREAD_STACK_SIZE 6144
...
static int data_template_light_thread(void)
{
...
#include <finsh.h>
FINSH_FUNCTION_EXPORT(tc_data_template_light_example, startup data template light example);
#endif

#ifdef FINSH_USING_MSH
MSH_CMD_EXPORT(tc_data_template_light_example, startup data template light example);
#endif
