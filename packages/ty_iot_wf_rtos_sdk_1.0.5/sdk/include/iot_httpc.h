...
#define LOG_SEQ_HTTP_TOKEN 1
#define LOG_SEQ_HTTP_TIME 3
#define LOG_SEQ_HTTP_API_NUM 10
...
OPERATE_RET http_gw_lan_node_report(IN CONST CHAR_T *devIds, OUT ty_cJSON **result);
#endif
...
*/
OPERATE_RET httpc_get_gw_upgrd_if_v43(IN CONST CHAR_T *url, IN CONST CHAR_T *gw_id, IN CONST CHAR_T *active_key, IN CONST CLOUD_DEV_TP_DEF_T tp, OUT ty_cJSON **result);
...
*/
OPERATE_RET httpc_gw_upgrd_stat_update_v41(IN CONST CHAR_T *url, IN CONST CHAR_T *gw_id, IN CONST CLOUD_DEV_TP_DEF_T tp, IN CONST CHAR_T *active_key, IN CONST BYTE_T stat);
...
*/
OPERATE_RET httpc_get_dev_upgrd_if_v43(IN CONST CHAR_T *url, IN CONST CHAR_T *gw_id, IN CONST CHAR_T *active_key, IN CONST CHAR_T *sub_id, IN CONST CLOUD_DEV_TP_DEF_T tp, OUT ty_cJSON **result);
...
*/
OPERATE_RET httpc_dev_upgrd_stat_update_v41(IN CONST CHAR_T *url, IN CONST CHAR_T *gw_id, IN CONST CHAR_T *active_key, IN CONST CHAR_T *sub_id, IN CONST CLOUD_DEV_TP_DEF_T tp, IN CONST BYTE_T stat);
