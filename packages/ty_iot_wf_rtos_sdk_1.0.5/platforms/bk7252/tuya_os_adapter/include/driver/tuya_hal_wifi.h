 ...
 * 
 */
typedef void (*WIFI_REV_MGNT_CB)(uint8_t *buf, int buf_len, NW_MAC_S *srcmac, NW_MAC_S *dstmac);
...
/**
 * @brief : tuya_hal_wifi_get_connected_ap_info_v2
...
/**
 * @brief : tuya_hal_fast_station_connect_v2
...
/**
 * @brief : tuya_hal_wifi_set_ap_num
 * @param[in]      num
 * @return  OPRT_OK: success  Other: fail
 */
